...
int		fmt_jd(va_list *va, int *flags)
{
	intmax_t	d;
	int			ret;
	int			prec;
...
int		fmt_jo(va_list *va, int *flags)
{
	uintmax_t	o;
	int			ret;
	int			prec;
...
int		fmt_ju(va_list *va, int *flags)
{
	uintmax_t	u;
	int			ret;

	ret = 0;
	u = va_arg(*va, uintmax_t);
	if (flags[13] && u == 0)
		return (print_spaces(flags));
	if (flags[2])
...
int		fmt_jx(va_list *va, int *flags)
{
	uintmax_t	x;
	int			ret;
	int			ln;
...
int		fmt_jbx(va_list *va, int *flags)
{
	uintmax_t	x;
	int			ret;
	int			ln;
